/*
 * Copyright 2021 Muthopay Limited
 */
@file:JvmName("Constants")

package com.muthopay.muthobrowser.constant
...
object Schemes {
    const val Styx = "styx"
    const val MuthoBrowser = "Mutho Browser"
...
object Uris {
    const val StyxHome = "${Schemes.MuthoBrowser}://${Hosts.Home}"
